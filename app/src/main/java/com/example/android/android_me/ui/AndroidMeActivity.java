...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    //TODO (2) Create a new class called BodyPartFragment to display an image of an Android-Me body part
        //In this case, you'll need to implement an empty constructor and the onCreateView method
    //TODO (3) Show the first Image in the list of head images
        //Soon, you'll update this image diplay code to show any image you want
    @Override
